...
juce::StringArray LiteLookAndFeel::cjkFallbackNames()
{
   #if JUCE_WINDOWS
...
juce::String LiteLookAndFeel::uiFontName()
{
...
juce::Font LiteLookAndFeel::uiFont (float height, int styleFlags)
{
...
LiteLookAndFeel::LiteLookAndFeel()
{
...
juce::Font LiteLookAndFeel::getTextButtonFont (juce::TextButton&, int) { return uiFont (14.0f); }
juce::Font LiteLookAndFeel::getLabelFont (juce::Label&) { return uiFont (14.0f); }
juce::Font LiteLookAndFeel::getComboBoxFont (juce::ComboBox&) { return uiFont (14.0f); }
juce::Font LiteLookAndFeel::getPopupMenuFont() { return uiFont (14.0f); }
juce::Font LiteLookAndFeel::getAlertWindowTitleFont() { return uiFont (16.0f, juce::Font::bold); }
juce::Font LiteLookAndFeel::getAlertWindowMessageFont() { return uiFont (14.0f); }
juce::Font LiteLookAndFeel::getAlertWindowFont() { return uiFont (14.0f); }
juce::Font LiteLookAndFeel::getMenuBarFont (juce::MenuBarComponent&, int, const juce::String&) { return uiFont (14.0f); }
juce::Font LiteLookAndFeel::getSliderPopupFont (juce::Slider&) { return uiFont (13.0f); }

int LiteLookAndFeel::getAlertBoxWindowFlags()
{
    // Keep off the taskbar; avoid windowIsTemporary (breaks keyboard focus / Tab).
    return juce::ComponentPeer::windowHasDropShadow;
}

bool LiteLookAndFeel::isAlertDefaultButton (const juce::Button& button)
{
...
void LiteLookAndFeel::drawComboBox (juce::Graphics& g, int width, int height, bool isButtonDown,
...
void LiteLookAndFeel::drawToggleButton (juce::Graphics& g, juce::ToggleButton& button,
...
void LiteLookAndFeel::drawButtonBackground (juce::Graphics& g, juce::Button& button, const juce::Colour& backgroundColour,
                                            bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown)
{
...
void LiteLookAndFeel::drawButtonText (juce::Graphics& g, juce::TextButton& button,
                                      bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown)
{
...
juce::Label* LiteLookAndFeel::createSliderTextBox (juce::Slider& slider)
{
...
void LiteLookAndFeel::drawRotarySlider (juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
...
juce::Label* LiteLookAndFeel::createComboBoxTextBox (juce::ComboBox& box)
{
...
void LiteLookAndFeel::fillTextEditorBackground (juce::Graphics& g, int width, int height, juce::TextEditor& editor)
{
    LookAndFeel_V4::fillTextEditorBackground (g, width, height, editor);
}

void LiteLookAndFeel::drawLabel (juce::Graphics& g, juce::Label& label)
{
